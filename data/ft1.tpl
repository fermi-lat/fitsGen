...
TTYPE12     = 'CALENERGYSUM'                            / sum of the raw energies in all the crystals
TFORM12     = 'E'                                       / data format of field: 4-byte REAL
TUNIT12     = 'MeV'                                     / physical unit of field
TLMIN12     = 0.0                                       / minimum value
TLMAX12     = 1.0e+7                                    / maximum value
TTYPE13     = 'CALTOTRLN'                               / total radiation lengths integrated along trajectory of first track
TFORM13     = 'E'                                       / data format of field: 4-byte REAL
TUNIT13     = ''                                        / physical unit of field: dimensionless
TLMIN13     = 0.0                                       / minimum value
TLMAX13     = 100.0                                     / maximum value
TTYPE14     = 'CONVERSION_LAYER'                        / conversion layer in TKR, -1 means not in TKR
TFORM14     = 'I'                                       / data format of field: 2-byte signed INTEGER
TLMIN14     = -1                                        / minimum value
TLMAX14     = 18                                        / maximum value
